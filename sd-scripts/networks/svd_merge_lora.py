...
def setup_parser() -> argparse.ArgumentParser:
  ...
  parser.add_argument("--new_rank", type=int, default=4,
                      help="Specify rank of output LoRA / ...LoRA...rank (dim)")
  parser.add_argument("--new_conv_rank", type=int, default=None,
                      help="Specify rank of output LoRA for Conv2d 3x3, None for same as new_rank / ...Conv2D 3x3 LoRA...rank (dim)...None...new_rank...")
