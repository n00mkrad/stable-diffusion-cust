...
def setup_parser() -> argparse.ArgumentParser:
  ...
  parser.add_argument("--save_precision", type=str, default=None,
                      choices=[None, "float", "fp16", "bf16"], help="precision in saving, float if omitted / ...float")
  ...
  parser.add_argument("--model", type=str, default=None,
                      help="LoRA model to resize at to new rank: ckpt or safetensors file / ...LoRA...ckpt...safetensors")
  parser.add_argument("--device", type=str, default=None, help="device to use, cuda for GPU / ...cuda ...GPU...")
  parser.add_argument("--verbose", action="store_true", 
                      help="Display verbose resizing information / rank...")
