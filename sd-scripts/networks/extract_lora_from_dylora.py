...
def setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--unit", type=int, default=None, help="size of rank to split into / rank...")
    parser.add_argument(
        "--save_to",
        type=str,
        default=None,
        help="destination base file name: ckpt or safetensors file / ...base...ckpt...safetensors",
    )
    parser.add_argument(
        "--model",
        type=str,
        default=None,
        help="DyLoRA model to resize at to new rank: ckpt or safetensors file / ...DyLoRA...ckpt...safetensors",
    )
