...
def train(args):
    ...
    if len(train_dataset_group) == 0:
        print(
            "No data found. Please verify the metadata file and train_data_dir option. / ...train_data_dir..."
        )
        return
    ...
    if args.diffusers_xformers:
        ...
        # Windows...xformers...float...xformers...
    ...
    print(f"  num examples / ...: {train_dataset_group.num_train_images}")
    ...
    for epoch in range(num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            current_loss = loss.detach().item()  # ...batch size...
...
def setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--diffusers_xformers", action="store_true", help="use xformers by diffusers / Diffusers...xformers...")
    parser.add_argument("--train_text_encoder", action="store_true", help="train text encoder / text encoder...")
