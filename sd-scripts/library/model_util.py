...
# region StableDiffusion->Diffusers...
# convert_original_stable_diffusion_to_diffusers ...ASL 2.0...
...
def convert_ldm_vae_checkpoint(checkpoint, config):
    ...
    #   # ...checkpoint....ckpt...checkpoint...vae...state_dict
...
# convert_diffusers_to_original_stable_diffusion ...ASL 2.0...
    ...
    if make_dummy_weights:
        ...
        for key in keys:
            if key.startswith("transformer.resblocks.22."):
                new_sd[key.replace(".22.", ".23.")] = new_sd[key].clone()  # copy...safetensors...
...
def save_stable_diffusion_checkpoint(v2, output_file, text_encoder, unet, ckpt_path, epochs, steps, save_dtype=None, vae=None):
    if ckpt_path is not None:
        ...
        if checkpoint is None:  # safetensors ... state_dict...ckpt
            checkpoint = {}
            strict = False
        else:
            strict = True
    ...
    if v2:
        make_dummy = ckpt_path is None  # ...checkpoint...
