...
def setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="BLIP caption weights (model_large_caption.pth) / BLIP caption...(model_large_caption.pth)",
    )
    parser.add_argument(
        "--caption_extention",
        type=str,
    ...
    parser.add_argument(
        "--beam_search",
        action="store_true",
        help="use beam search (default Nucleus sampling) / beam search...Nucleus sampling...",
    )
    ...
    parser.add_argument("--num_beams", type=int, default=1, help="num of beams in beam search /beam search...")
    parser.add_argument("--top_p", type=float, default=0.9, help="top_p in Nucleus sampling / Nucleus sampling...top_p")
    parser.add_argument("--max_length", type=int, default=75, help="max length of caption / caption...")
    parser.add_argument("--min_length", type=int, default=5, help="min length of caption / caption...")
    parser.add_argument("--seed", default=42, type=int, help="seed for reproducibility / ...seed")
