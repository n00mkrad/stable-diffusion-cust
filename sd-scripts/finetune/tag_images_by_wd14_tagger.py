...
def main(args):
    # hf_hub_download...symlink...force_filename...
    # depreacated...
...
def setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="repo id for wd14 tagger on Hugging Face / Hugging Face...wd14 tagger...ID",
    )
    parser.add_argument(
        "--model_dir",
        type=str,
        default="wd14_tagger_model",
        help="directory to store wd14 tagger model / wd14 tagger...",
    )
    parser.add_argument(
        "--force_download", action="store_true", help="force downloading wd14 tagger models / wd14 tagger..."
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="threshold of confidence to add a tag for general category, same as --thresh if omitted / general... --thresh ...",
    )
    parser.add_argument(
        "--character_threshold",
        type=float,
        default=None,
        help="threshold of confidence to add a tag for character category, same as --thres if omitted / character... --thresh ...",
    )
