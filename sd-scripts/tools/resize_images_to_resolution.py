...
def setup_parser() -> argparse.ArgumentParser:
  ...
  parser.add_argument('--max_resolution', type=str,
                      help='Maximum resolution(s) in the format "512x512,384x384, etc, etc" / ... ("512x512,384x384, etc, etc" ...)', default="512x512,384x384,256x256,128x128")
  ...
  parser.add_argument('--save_as_png', action='store_true', help='Save as png format / png...')
