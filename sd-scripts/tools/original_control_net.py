...
def load_control_net(v2, unet, model):
  ...
  # control sd...U-Net...Diffusers...U-Net...
  # state dict...
  ...
  # ...U-Net...ControlNet...SD...state dict...
  is_difference = "difference" in ctrl_sd_sd
  print("ControlNet: loading difference")

  # ControlNet...U-Net...SD...key...
  # ...Transfer Control...weight...
  ...
  ctrl_unet_du_sd = model_util.convert_ldm_unet_checkpoint(v2, ctrl_unet_sd_sd, unet_config)    # DiffUsers...ControlNet...state dict
...
def get_guided_hints(control_nets: List[ControlNetInfo], num_latent_input, b_size, hints):
  ...
  for i, cnet_info in enumerate(control_nets):
    # hint... 1...cnet1, 1...cnet2, 1...cnet3, 2...cnet1, 2...cnet2 ... ...
    b_hints = []
    if len(hints) == 1:           # ...hint...
      hint = hints[0]
